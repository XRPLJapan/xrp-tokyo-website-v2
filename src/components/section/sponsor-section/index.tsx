...
logoClass: "w-full max-w-[240px] md:max-w-none aspect-[1.8/1] border-2 border-[#D4AF37] rounded-lg bg-black/20 shadow-[0_0_10px_rgba(212,175,55,0.2)]",
  ...
  {
    tier: Tier.Silver,
    containerClass: "flex flex-wrap justify-center items-start gap-4 w-full max-w-xl mx-auto",
   logoClass: "w-[calc(50%-0.5rem)] max-w-[200px] aspect-[1.5/1] border-[1.5px] border-[#C0C0C0] rounded-md bg-black/10 shadow-[0_0_8px_rgba(192,192,192,0.15)]",
    gap: "mt-12 md:mt-14",
    titleGap: "mb-4",
    initialY: 28,
  },
